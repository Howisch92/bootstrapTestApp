...
var notsupported = "<div style='font:12px courier;width:250px;'>Dette element er ikke supporteret af denne browser. Prøv f.eks. <a href=\"http://windows.microsoft.com/da-dk/internet-explorer/products/ie/home\">Internet Explorer 9 (eller nyere)</a>, <a href=\"https://www.google.com/chrome\">Google Chrome</a> eller <a href=\"http://www.mozilla.org/da/firefox/new/\">Firefox</a>.</div>";

export { TBE, notsupported };